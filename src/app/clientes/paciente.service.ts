...
export class PacienteService {
    ...
    adicionarPaciente(nome: string, fone: string, email: string,senha: string,estado:string,datanasc:string) {
        ...
        this.httpClient.post<{ mensagem: string, id: string }>('http://localhost:3000/api/pacientes',
            paciente).subscribe(
                (dados) => {
    ...
    {
        const paciente: Paciente = { id, nome, fone, email,senha,estado,datanasc};
